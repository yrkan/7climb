...
@Composable
private fun CompactLargePreview() = CompactLarge(ClimbDisplayState.PREVIEW)

@Preview(widthDp = 200, heightDp = 100)
@Composable
private fun CompactMediumWidePreview() = CompactMediumWide(ClimbDisplayState.PREVIEW)

@Preview(widthDp = 120, heightDp = 100)
@Composable
private fun CompactMediumPreview() = CompactMedium(ClimbDisplayState.PREVIEW)

@Preview(widthDp = 100, heightDp = 200)
@Composable
private fun CompactNarrowPreview() = CompactNarrow(ClimbDisplayState.PREVIEW)

@Preview(widthDp = 180, heightDp = 60)
@Composable
private fun CompactSmallWidePreview() = CompactSmallWide(ClimbDisplayState.PREVIEW)

@Preview(widthDp = 100, heightDp = 60)
@Composable
private fun CompactSmallPreview() = CompactSmall(ClimbDisplayState.PREVIEW)
